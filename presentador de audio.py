...
def RepAudio(x,y): #Se define una funcion con 2 argumentos de entrada
    for i in range(y): #En un rango determinado por el segundo argumento de la funcion
        mp3 = (x+ ".mp3") #Se le asigna a una variable el arcivo mp3 a reproducirse
